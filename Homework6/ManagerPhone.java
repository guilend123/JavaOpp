...
import Homework6.NewPhone;
import Homework6.OldPhone;
...
public class ManagerPhone {
    ...
    static {
        oldPhones.add(new OldPhone("DTC001", "Redmagic 6", 179990, 3, "Samsung", 90, "Used"));
        oldPhones.add(new OldPhone("DTC002", "BlackShard 3", 179990, 3, "Samsung", 90, "Used"));
        newPhones.add(new NewPhone("DTM001", "Redmagic 9", 2000000, 2, "Apple", 20));
        newPhones.add(new NewPhone("DTM002", "BlackShard 5", 2000000, 2, "Apple", 20));
            ...
            do {
                ...
                switch (choose) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        System.out.println("Tổng giá của các điện thoại " + calculatePhone());
                    case 8:
                        System.out.print(" Enter percent discount: ");
                        double percent = Double.parseDouble(scanner.nextLine());
                        discountOldPhone(percent);
                        break;
                    case 9:
                        return;
                    default:
    ...
    public static double calculatePhone() {
    ...
    public static void discountOldPhone(double percent) {
        boolean idExit = true;
        do {
            ...
            for (Phone phone : phones) {
                if (phone.getId().equals(id)) {
                    ...
                    if (phone instanceof OldPhone) {
                        ((OldPhone) phone).applyDiscount(discountPercent);
